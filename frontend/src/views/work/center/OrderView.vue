  ...
  <a-modal v-model="show" title="订单详情" @cancel="onClose" :width="1300">
    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="orderInfo !== null">
      ...
      <a-row style="padding-left: 24px;padding-right: 24px;">
        ...
        <a-col :span="6" v-if="orderData.orderType == 1"><b>装修难度：</b>
      ...
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">装修瑕疵</span></a-col>
        <a-col :span="24">
    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="staffInfo !== null">
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">设计师信息</span></a-col>
        <a-col :span="6"><b>设计师姓名：</b>
          {{ staffInfo.name }}
        </a-col>
        <a-col :span="6"><b>性别：</b>
