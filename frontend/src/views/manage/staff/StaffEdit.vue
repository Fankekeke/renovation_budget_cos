<template>
  <a-modal v-model="show" title="修改设计师" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        <a-col :span="12">
          <a-form-item label='设计师姓名' v-bind="formItemLayout">
            <a-input v-decorator="[
            'name',
        ...
        <a-col :span="12">
          <a-form-item label='设计师性别' v-bind="formItemLayout">
            <a-select v-decorator="[
              'sex',
              { rules: [{ required: true, message: '请输入设计师性别!' }] }
              ]">
